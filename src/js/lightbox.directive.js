		...
		return {
			...
			link : function(scope, elem, attrs){
				...
				/*===================================================
					...
					@before starting the directive
					@need to check the data from scope by user first
					@to prevent error throw
				...
				/*=======================================================
					...
					@do some stuff like add animation class
					@and positon the lightbox according to user's option
				...
				/*===================================================
					...
					@register a src watcher for the 
					@album current index, if there is changes inside
					@the current src, the watcher will be fired
				...
				/*=======================================================
					...
					@implement end function inside lightbox
					@because all the close has been done by modal module 
					@I will broadcast event here
				...
				function positionLightBox(){
					...
					//implement line 171 onwards on lightbox.js 
				...
				/*====================================================
					...
					@add css3 animation corresponding to user's option
					@in fadeIn and resize duration
				...
				function albumLabel(){
					return 'Image ' + _this.currentImageIndex + " of " + _this.album.length; 
				}
            ...
            _this.element.$body.bind('keyup', function(event){
				...
				_this.element 			= {
					...
					//lightbox is exactly the element 
					$lightbox 		: elem,
